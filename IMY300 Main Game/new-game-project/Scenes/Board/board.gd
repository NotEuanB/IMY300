...
func _show_step_popup() -> void:
	match GameState.current_step:
		...
		GameState.GameStep.STEP_1_3:
			...
			$HighlightBoard/HighlightAnimation.stop()
			$HighlightBoard.queue_free()
		...
		GameState.GameStep.STEP_1_4:
			...
			$HighlightUnit/HighlightAnimation.stop()
			$HighlightUnit.queue_free()
		...
		GameState.GameStep.STEP_1_5:
			...
			$HighlightGold/HighlightAnimation.stop()
			$HighlightGold.queue_free()
		...
		GameState.GameStep.STEP_1_6:
			...
			$HighlightReroll/HighlightAnimation.stop()
			$HighlightReroll.queue_free()
